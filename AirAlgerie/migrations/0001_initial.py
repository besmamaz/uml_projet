    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_idcategorie', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='AirAlgerie.categoriee')),
            ],
            options={
                'db_table': 'passager',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_idavion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirAlgerie.aviion')),
                ('fk_idvol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirAlgerie.vool')),
            ],
            options={
                'db_table': 'trajet',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_passager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirAlgerie.passsager')),
                ('fk_nvol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirAlgerie.vool')),
            ],
            options={
